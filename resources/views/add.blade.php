  ...
  <body>
    <div>
        <div class="container2">
            <h4 class="judul">Tambah Data Kendaraan</h4>
            <div class="card">
                ...
                <div class="card-body">
                    <form  method="POST" action="{{url('kendaraan')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                            <input type="number" class="form-control form-control-sm @error('txtcc') is-invalid @enderror" id="txtcc" name="txtcc" value="{{ old('txtcc') }}">
                            @error('txtcc')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
